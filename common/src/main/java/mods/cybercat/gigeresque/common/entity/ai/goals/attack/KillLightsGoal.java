...
public class KillLightsGoal extends Goal {
    ...
    public KillLightsGoal(AlienEntity mob) {
        this.mob = mob;
    }
    ...
    public boolean canUse() {
        ...
        return !this.mob.isAggressive() && !this.mob.isVehicle() && !this.mob.stasisManager.isStasis() && this.targetBlock.isPresent();
    }
    ...
    private Optional<BlockPos> findNearestDestructibleLight() {
        ...
        return BlockPos.betweenClosedStream(
            ...
            .filter(pos -> this.mob.level().getBlockState(pos).is(GigTags.DESTRUCTIBLE_LIGHT))
