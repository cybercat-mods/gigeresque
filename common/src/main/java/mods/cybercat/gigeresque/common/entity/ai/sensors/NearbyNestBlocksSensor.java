...
public class NearbyNestBlocksSensor<E extends LivingEntity> extends PredicateSensor<BlockState, E> {
    ...
    protected void doTick(ServerLevel level, E entity) {
        ...
        if (blocks.isEmpty()) BrainUtils.clearMemory(entity, GigMemoryTypes.NEARBY_NEST_BLOCKS.get());
        else BrainUtils.setMemory(entity, GigMemoryTypes.NEARBY_NEST_BLOCKS.get(), blocks);
    }
}