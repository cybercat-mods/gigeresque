...
public class ClassicAlienAnimator extends AzEntityAnimator<ClassicAlienEntity> {
    ...
    @Override
    public void registerControllers(AzAnimationControllerContainer<ClassicAlienEntity> animationControllerContainer) {
        animationControllerContainer.add(
            AzAnimationController.builder(this, Constants.BASE_CONTROLLER)
                .setTransitionLength(5)
                .setKeyframeCallbacks(
                    AzKeyframeCallbacks.<ClassicAlienEntity>builder()
