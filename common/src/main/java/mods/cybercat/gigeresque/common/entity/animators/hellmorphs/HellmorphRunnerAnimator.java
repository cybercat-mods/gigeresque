...
public class HellmorphRunnerAnimator extends AzEntityAnimator<HellmorphRunnerEntity> {

    private static final ResourceLocation ANIMATIONS = Constants.modResource(
        "animations/entity/hellmorph_runner/hellmorph_runner.animation.json"
    );

    @Override
    public void registerControllers(AzAnimationControllerContainer<HellmorphRunnerEntity> animationControllerContainer) {
        animationControllerContainer.add(
            AzAnimationController.builder(this, Constants.BASE_CONTROLLER)
                .setTransitionLength(5)
                .setKeyframeCallbacks(
                    AzKeyframeCallbacks.<HellmorphRunnerEntity>builder()
    ...
    @Override
    public @NotNull ResourceLocation getAnimationLocation(HellmorphRunnerEntity animatable) {
        return ANIMATIONS;
    }
}
