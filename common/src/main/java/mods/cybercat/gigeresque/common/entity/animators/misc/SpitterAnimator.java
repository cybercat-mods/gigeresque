...
public class SpitterAnimator extends AzEntityAnimator<SpitterEntity> {

    private static final ResourceLocation ANIMATIONS = Constants.modResource(
        "animations/entity/spitter/spitter.animation.json"
    );

    @Override
    public void registerControllers(AzAnimationControllerContainer<SpitterEntity> animationControllerContainer) {
        animationControllerContainer.add(
            AzAnimationController.builder(this, Constants.BASE_CONTROLLER)
                .setTransitionLength(5)
                .setKeyframeCallbacks(
                    AzKeyframeCallbacks.<SpitterEntity>builder()
    ...
    @Override
    public @NotNull ResourceLocation getAnimationLocation(SpitterEntity animatable) {
        return ANIMATIONS;
    }
}
