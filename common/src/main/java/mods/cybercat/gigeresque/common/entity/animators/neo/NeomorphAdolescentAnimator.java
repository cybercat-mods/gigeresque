...
public class NeomorphAdolescentAnimator extends AzEntityAnimator<NeomorphAdolescentEntity> {

    private static final ResourceLocation ANIMATIONS = Constants.modResource(
        "animations/entity/neomorph_adolescent/neomorph_adolescent.animation.json"
    );

    @Override
    public void registerControllers(AzAnimationControllerContainer<NeomorphAdolescentEntity> animationControllerContainer) {
        animationControllerContainer.add(
            AzAnimationController.builder(this, Constants.BASE_CONTROLLER)
                .setTransitionLength(5)
                .setKeyframeCallbacks(
                    AzKeyframeCallbacks.<NeomorphAdolescentEntity>builder()
    ...
    @Override
    public @NotNull ResourceLocation getAnimationLocation(NeomorphAdolescentEntity animatable) {
        return ANIMATIONS;
    }
}
