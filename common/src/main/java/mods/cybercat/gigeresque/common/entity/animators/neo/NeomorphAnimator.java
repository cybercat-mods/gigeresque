...
public class NeomorphAnimator extends AzEntityAnimator<NeomorphEntity> {

    private static final ResourceLocation ANIMATIONS = Constants.modResource(
        "animations/entity/neomorph/neomorph.animation.json"
    );

    @Override
    public void registerControllers(AzAnimationControllerContainer<NeomorphEntity> animationControllerContainer) {
    ...
    @Override
    public @NotNull ResourceLocation getAnimationLocation(NeomorphEntity animatable) {
        return ANIMATIONS;
    }
}
