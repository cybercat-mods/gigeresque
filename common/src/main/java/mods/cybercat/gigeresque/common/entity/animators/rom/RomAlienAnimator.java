package mods.cybercat.gigeresque.common.entity.animators.rom;
...
public class RomAlienAnimator extends AzEntityAnimator<RomAlienEntity> {

    private static final ResourceLocation ANIMATIONS = Constants.modResource(
        "animations/entity/rom_alien/rom_alien.animation.json"
    );

    @Override
    public void registerControllers(AzAnimationControllerContainer<RomAlienEntity> animationControllerContainer) {
        animationControllerContainer.add(
            AzAnimationController.builder(this, Constants.BASE_CONTROLLER)
                .setTransitionLength(5)
                .setKeyframeCallbacks(
                    AzKeyframeCallbacks.<RomAlienEntity>builder()
    ...
    @Override
    public @NotNull ResourceLocation getAnimationLocation(RomAlienEntity animatable) {
        return ANIMATIONS;
    }
}
