...
public class RunnerAlienAnimator extends AzEntityAnimator<RunnerAlienEntity> {
    ...
    private static final ResourceLocation ANIMATIONS = Constants.modResource(
        "animations/entity/runner_alien/runner_alien.animation.json"
    );

    @Override
    public void registerControllers(AzAnimationControllerContainer<RunnerAlienEntity> animationControllerContainer) {
        animationControllerContainer.add(
            AzAnimationController.builder(this, Constants.BASE_CONTROLLER)
                .setTransitionLength(5)
                .setKeyframeCallbacks(
                    AzKeyframeCallbacks.<RunnerAlienEntity>builder()
    ...
    @Override
    public @NotNull ResourceLocation getAnimationLocation(RunnerAlienEntity animatable) {
        return ANIMATIONS;
    }
}
