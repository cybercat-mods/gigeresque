...
public class DraconicTempleBeastAnimator extends AzEntityAnimator<DraconicTempleBeastEntity> {

    private static final ResourceLocation ANIMATIONS = Constants.modResource(
        "animations/entity/draconictemplebeast/draconictemplebeast.animation.json"
    );

    @Override
    public void registerControllers(AzAnimationControllerContainer<DraconicTempleBeastEntity> animationControllerContainer) {
        animationControllerContainer.add(
            AzAnimationController.builder(this, Constants.BASE_CONTROLLER)
                .setTransitionLength(5)
                .setKeyframeCallbacks(
                    AzKeyframeCallbacks.<DraconicTempleBeastEntity>builder()
    ...
    @Override
    public @NotNull ResourceLocation getAnimationLocation(DraconicTempleBeastEntity animatable) {
        return ANIMATIONS;
    }
}
