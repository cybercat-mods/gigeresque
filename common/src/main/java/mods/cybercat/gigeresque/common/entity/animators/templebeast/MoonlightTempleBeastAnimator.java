package mods.cybercat.gigeresque.common.entity.animators.templebeast;
...
public class MoonlightTempleBeastAnimator extends AzEntityAnimator<MoonlightHorrorTempleBeastEntity> {

    private static final ResourceLocation ANIMATIONS = Constants.modResource(
        "animations/entity/moonlighthorrortemplebeast/moonlighthorrortemplebeast.animation.json"
    );

    @Override
    public void registerControllers(AzAnimationControllerContainer<MoonlightHorrorTempleBeastEntity> animationControllerContainer) {
        animationControllerContainer.add(
            AzAnimationController.builder(this, Constants.BASE_CONTROLLER)
                .setTransitionLength(5)
                .setKeyframeCallbacks(
                    AzKeyframeCallbacks.<MoonlightHorrorTempleBeastEntity>builder()
    ...
    @Override
    public @NotNull ResourceLocation getAnimationLocation(MoonlightHorrorTempleBeastEntity animatable) {
        return ANIMATIONS;
    }
}
