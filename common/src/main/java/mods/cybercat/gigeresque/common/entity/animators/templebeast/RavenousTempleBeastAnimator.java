...
public class RavenousTempleBeastAnimator extends AzEntityAnimator<RavenousTempleBeastEntity> {

    private static final ResourceLocation ANIMATIONS = Constants.modResource(
        "animations/entity/ravenoustemplebeast/ravenoustemplebeast.animation.json"
    );

    @Override
    public void registerControllers(AzAnimationControllerContainer<RavenousTempleBeastEntity> animationControllerContainer) {
        animationControllerContainer.add(
            AzAnimationController.builder(this, Constants.BASE_CONTROLLER)
                .setTransitionLength(5)
                .setKeyframeCallbacks(
                    AzKeyframeCallbacks.<RavenousTempleBeastEntity>builder()
    ...
    @Override
    public @NotNull ResourceLocation getAnimationLocation(RavenousTempleBeastEntity animatable) {
        return ANIMATIONS;
    }
}
