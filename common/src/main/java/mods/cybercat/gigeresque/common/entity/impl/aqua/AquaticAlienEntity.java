...
public class AquaticAlienEntity extends NewAlienEntity implements SmartBrainOwner<AquaticAlienEntity> {

    public int killCounter;

    public AquaticAlienEntity(EntityType<? extends NewAlienEntity> type, Level world) {
        super(type, world);
