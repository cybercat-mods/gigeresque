...
public class BaphomorphEntity extends AlienEntity {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return LivingEntity.createLivingAttributes().add(Attributes.MAX_HEALTH,
                CommonMod.config.baphomorphXenoHealth).add(Attributes.ARMOR,
                CommonMod.config.baphomorphXenoArmor).add(Attributes.ARMOR_TOUGHNESS, 0.0).add(
                ...
                CommonMod.config.baphomorphAttackDamage).add(Attributes.ATTACK_KNOCKBACK, 0.3);
    }
