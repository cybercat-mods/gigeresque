...
public class HellmorphRunnerEntity extends NewAlienEntity implements SmartBrainOwner<HellmorphRunnerEntity> {

    public HellmorphRunnerEntity(EntityType<? extends NewAlienEntity> entityType, Level level) {
