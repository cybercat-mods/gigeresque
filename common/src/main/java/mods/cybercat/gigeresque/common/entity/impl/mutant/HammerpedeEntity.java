...
public class HammerpedeEntity extends AlienEntity implements SmartBrainOwner<HammerpedeEntity> {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return LivingEntity.createLivingAttributes().add(Attributes.MAX_HEALTH, CommonMod.config.hammerpedeHealth).add(
                ...
                CommonMod.config.hammerpedeAttackDamage).add(Attributes.FOLLOW_RANGE, 16.0).add(
