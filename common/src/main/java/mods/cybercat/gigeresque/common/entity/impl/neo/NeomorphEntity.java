 ...
 */
public class NeomorphEntity extends NewAlienEntity implements SmartBrainOwner<NeomorphEntity> {

    public NeomorphEntity(EntityType<? extends NewAlienEntity> entityType, Level world) {
