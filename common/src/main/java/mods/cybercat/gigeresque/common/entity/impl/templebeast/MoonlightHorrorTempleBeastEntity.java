...
public class MoonlightHorrorTempleBeastEntity extends AlienEntity {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return LivingEntity.createLivingAttributes().add(Attributes.MAX_HEALTH,
                CommonMod.config.moonlightHorrorTempleBeastXenoHealth).add(Attributes.ARMOR,
                CommonMod.config.moonlightHorrorTempleBeastXenoArmor).add(Attributes.ARMOR_TOUGHNESS, 0.0).add(
                ...
                CommonMod.config.moonlightHorrorTempleBeastAttackDamage).add(Attributes.ATTACK_KNOCKBACK, 0.3);
    }
