...
public class GigDungeonStructure extends Structure {
    ...
    public static final MapCodec<GigDungeonStructure> CODEC = RecordCodecBuilder.<GigDungeonStructure>mapCodec(
    ...
    public GigDungeonStructure(StructureSettings config, Holder<StructureTemplatePool> startPool, Optional<ResourceLocation> startJigsawName, int size, int maxDistanceFromCenter) {
        super(config);
