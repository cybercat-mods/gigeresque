...
public class GigSculkDungeonStructure extends Structure {
    ...
    public GigSculkDungeonStructure(StructureSettings config, Holder<StructureTemplatePool> startPool, Optional<ResourceLocation> startJigsawName, int size, int maxDistanceFromCenter) {
        super(config);
    ...
    public @NotNull StructureType<?> type() {
        return GigStructures.SCULK_GIG_DUNGEON.get();
    }
}