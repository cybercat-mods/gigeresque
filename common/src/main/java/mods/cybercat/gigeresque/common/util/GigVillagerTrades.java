...
public record GigVillagerTrades() {
    ...
    public static void addTrades() {
        ...
        gigTrades.add(new TreasureMapForEmeralds(13, GigTags.GIG_EXPLORER_MAPS, "filled_map.gig_dungeon",MapDecorationTypes.RED_MARKER, 12, 5));
        ...
        gigTrades2.add(new TreasureMapForEmeralds(13, GigTags.GIG_EXPLORER_MAPS, "filled_map.gig_dungeon", MapDecorationTypes.RED_MARKER, 12, 5));
