...
public class EnglishNewZealandLanguageProvider extends FabricLanguageProvider {
    ...
    public EnglishNewZealandLanguageProvider(
    ...
    public void generateTranslations(HolderLookup.Provider registryLookup, TranslationBuilder builder) {
        ...
        builder.add("config.gigeresque.option.classicXenoArmor", "Entombed Interloper Armour");
        ...
        builder.add("config.gigeresque.option.aquaticXenoArmor", "Threshing Interloper Armour");
        ...
        builder.add("config.gigeresque.option.stalkerXenoArmor", "Stalker Armour");
        ...
        builder.add("config.gigeresque.option.runnerXenoArmor", "Lithe Interloper Armour");
        ...
        builder.add("config.gigeresque.option.spitterXenoArmor", "Melting Interloper Armour");
        ...
        builder.add("config.gigeresque.option.neomorphXenoArmor", "Maiming Pale Armour");
        ...
        builder.add("config.gigeresque.option.draconicTempleBeastXenoArmor", "Draconic Templebeast Armour");
        ...
        builder.add("config.gigeresque.option.ravenousTempleBeastXenoArmor", "Rapacious Templebeast Armour");
        ...
        builder.add("config.gigeresque.option.moonlightHorrorTempleBeastXenoArmor", "Moonlight Templebeast Armour");
        ...
        builder.add("config.gigeresque.option.baphomorphXenoArmor", "Charnel Templebeast Armour");
        ...
        builder.add("config.gigeresque.option.hellmorph_runnerXenoArmor", "Infernal Interloper Armour");
