...
public class NeoForgeClientMod {
    ...
    public static void registerRenderers(final EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(GigEntities.ALIEN.get(), mods.cybercat.gigeresque.client.entity.render.classic.AlienEntityRenderer::new);
        // event.registerEntityRenderer(GigEntities.ROM_ALIEN.get(), AlienRomEntityRenderer::new);
        event.registerEntityRenderer(GigEntities.AQUATIC_ALIEN.get(), mods.cybercat.gigeresque.client.entity.render.aqua.AquaticAlienEntityRenderer::new);
        ...
        event.registerEntityRenderer(GigEntities.FACEHUGGER.get(), mods.cybercat.gigeresque.client.entity.render.classic.FacehuggerEntityRenderer::new);
        event.registerEntityRenderer(GigEntities.RUNNER_ALIEN.get(), mods.cybercat.gigeresque.client.entity.render.runner.RunnerAlienEntityRenderer::new);
        event.registerEntityRenderer(GigEntities.RUNNERBURSTER.get(), RunnerbursterEntityRenderer::new);
        event.registerEntityRenderer(GigEntities.MUTANT_POPPER.get(), mods.cybercat.gigeresque.client.entity.render.mutant.PopperEntityRenderer::new);
        event.registerEntityRenderer(GigEntities.MUTANT_HAMMERPEDE.get(), mods.cybercat.gigeresque.client.entity.render.mutant.HammerpedeEntityRenderer::new);
        event.registerEntityRenderer(GigEntities.MUTANT_STALKER.get(), StalkerEntityRenderer::new);
        event.registerEntityRenderer(GigEntities.NEOBURSTER.get(), mods.cybercat.gigeresque.client.entity.render.neo.NeobursterRenderer::new);
        event.registerEntityRenderer(GigEntities.NEOMORPH_ADOLESCENT.get(), mods.cybercat.gigeresque.client.entity.render.neo.NeomorphAdolescentRenderer::new);
        ...
        event.registerEntityRenderer(GigEntities.DRACONICTEMPLEBEAST.get(), mods.cybercat.gigeresque.client.entity.render.templebeast.DraconicTempleBeastEntityRenderer::new);
        event.registerEntityRenderer(GigEntities.MOONLIGHTHORRORTEMPLEBEAST.get(), mods.cybercat.gigeresque.client.entity.render.templebeast.MoonlightHorrorTempleBeastEntityRenderer::new);
        event.registerEntityRenderer(GigEntities.HELLMORPH_RUNNER.get(), mods.cybercat.gigeresque.client.entity.render.hellmorphs.HellmorphRunnerEntityRenderer::new);
        event.registerEntityRenderer(GigEntities.BAPHOMORPH.get(), BaphomorphEntityRenderer::new);
        event.registerEntityRenderer(GigEntities.HELL_BURSTER.get(), mods.cybercat.gigeresque.client.entity.render.hellmorphs.HellbursterEntityRenderer::new);
