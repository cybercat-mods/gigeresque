...
public class FluidRenderHandlersJava implements GigeresqueInitializerJava {
    ...
    private void initializeImpl() {
        setupFluidRendering(
                ...
                FluidsJava.BLACK_FLUID_FLOWING,
                new Identifier(GigeresqueJava.MOD_ID, "black_fluid")
        );
    ...
    private void setupFluidRendering(Fluid still, Fluid flowing, Identifier textureFluidId) {
        var stillSpriteId =
                new Identifier(textureFluidId.getNamespace(), "block/" + textureFluidId.getPath() + "_still");
        var flowingSpriteId =
                new Identifier(textureFluidId.getNamespace(), "block/" + textureFluidId.getPath() + "_flow");
