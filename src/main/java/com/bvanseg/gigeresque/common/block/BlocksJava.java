...
public class BlocksJava implements GigeresqueInitializerJava {
        /*
        FLUID BLOCKS
     */
    public static final FluidBlock BLACK_FLUID = new FluidBlock(
            FluidsJava.BLACK_FLUID_STILL,
    ...
    public static final AcidBlockJava ACID_BLOCK = new AcidBlockJava(FabricBlockSettings.of(MaterialsJava.ACID).noCollision());

    public static final NestResinBlockJava NEST_RESIN = new
            NestResinBlockJava(FabricBlockSettings.of(MaterialsJava.NEST_RESIN).sounds(BlockSoundGroup.HONEY).strength(5.0f, 8.0f));
    public static final Block NEST_RESIN_BLOCK = new
            Block(FabricBlockSettings.of(MaterialsJava.NEST_RESIN).sounds(BlockSoundGroup.HONEY).strength(5.0f, 8.0f));
    public static final NestResinWebBlockJava NEST_RESIN_WEB = new
            NestResinWebBlockJava(
                    FabricBlockSettings.of(MaterialsJava.NEST_RESIN).sounds(BlockSoundGroup.HONEY).noCollision()
                            .strength(5.0f, 8.0f)
            );
    public static final NestResinWebFullBlockJava NEST_RESIN_WEB_CROSS = new
            NestResinWebFullBlockJava(
                    FabricBlockSettings.of(MaterialsJava.NEST_RESIN_WEB).sounds(BlockSoundGroup.HONEY).noCollision().nonOpaque()
                            .requiresTool().strength(5.0f, 8.0f)
            );

    private static final Block ORGANIC_ALIEN_BLOCK = new Block(FabricBlockSettings.of(MaterialsJava.ORGANIC_ALIEN_BLOCK).strength(3.0F, 6.0F).sounds(BlockSoundGroup.NETHERRACK));
    private static final Block RESINOUS_ALIEN_BLOCK = new Block(FabricBlockSettings.of(MaterialsJava.ROUGH_ALIEN_BLOCK).requiresTool().strength(3.0F, 6.0F).sounds(BlockSoundGroup.DEEPSLATE));
    private static final Block RIBBED_ALIEN_BLOCK = new Block(
            FabricBlockSettings.of(MaterialsJava.ROUGH_ALIEN_BLOCK).requiresTool()
    ...
    private static final Block SINOUS_ALIEN_BLOCK = new Block(
            FabricBlockSettings.of(MaterialsJava.SINOUS_ALIEN_BLOCK).requiresTool()
                    .strength(3.0F, 6.0F).sounds(BlockSoundGroup.DEEPSLATE)
    );
    ...
    /*
        STAIRS
     */
    private static final CustomStairsBlockJava ORGANIC_ALIEN_STAIRS = new CustomStairsBlockJava(ORGANIC_ALIEN_BLOCK);
    private static final CustomStairsBlockJava RESINOUS_ALIEN_STAIRS = new CustomStairsBlockJava(RESINOUS_ALIEN_BLOCK);
    private static final CustomStairsBlockJava RIBBED_ALIEN_STAIRS = new CustomStairsBlockJava(RIBBED_ALIEN_PILLAR);
    private static final CustomStairsBlockJava ROUGH_ALIEN_STAIRS = new CustomStairsBlockJava(ROUGH_ALIEN_BLOCK);
    private static final CustomStairsBlockJava SINOUS_ALIEN_STAIRS = new CustomStairsBlockJava(SINOUS_ALIEN_BLOCK);
    private static final CustomStairsBlockJava SMOOTH_ALIEN_STAIRS = new CustomStairsBlockJava(SMOOTH_ALIEN_PILLAR);
    ...
    private void registerItemBlock(String path, Block block, FabricItemSettings settings) {
        Registry.register(Registry.BLOCK, new Identifier(GigeresqueJava.MOD_ID, path), block);
        Registry.register(Registry.ITEM, new Identifier(GigeresqueJava.MOD_ID, path), new BlockItem(block, settings.group(ItemGroupsJava.GENERAL)));
    }
    ...
    private void initializeImpl() {
        Registry.register(Registry.BLOCK, new Identifier(GigeresqueJava.MOD_ID, "black_fluid"), BLACK_FLUID);
        ...
        Registry.register(Registry.BLOCK, new Identifier(GigeresqueJava.MOD_ID, "acid_block"), ACID_BLOCK);
