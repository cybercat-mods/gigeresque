...
public class GigeresqueConfigJava implements ConfigData {
    ...
    public static class Miscellaneous {
        ...
        public int alienSpawnCap = ConstantsJava.ALIEN_SPAWN_CAP;
    ...
    public static class Morphing {
        ...
        @ConfigEntry.Gui.Tooltip(count = 1)
        public List<String> aquaticAlienHosts = List.of(
                Registry.ENTITY_TYPE.getId(EntityType.DOLPHIN).toString()
        );

        @ConfigEntry.Gui.Tooltip(count = 1)
        public List<String> runnerHosts = List.of(
    ...
    public static class Targeting {
        ...
        @ConfigEntry.Gui.Tooltip(count = 1)
        public List<String> alienBlacklist = List.of(
        ...
        @ConfigEntry.Gui.Tooltip(count = 1)
        public List<String> aquaticAlienBlacklist = List.of(
                Registry.ENTITY_TYPE.getId(EntityType.BAT).toString(),
                Registry.ENTITY_TYPE.getId(EntityType.BEE).toString(),
                Registry.ENTITY_TYPE.getId(EntityType.CAT).toString(),
                Registry.ENTITY_TYPE.getId(EntityType.CREEPER).toString(),
        ...
        @ConfigEntry.Gui.Tooltip(count = 1)
        public List<String> facehuggerBlacklist = List.of(
        ...
        @ConfigEntry.Gui.Tooltip(count = 1)
        public List<String> runnerBlacklist = List.of(
                Registry.ENTITY_TYPE.getId(EntityType.BAT).toString(),
                Registry.ENTITY_TYPE.getId(EntityType.BEE).toString(),
                Registry.ENTITY_TYPE.getId(EntityType.CAT).toString(),
                Registry.ENTITY_TYPE.getId(EntityType.CREEPER).toString(),
