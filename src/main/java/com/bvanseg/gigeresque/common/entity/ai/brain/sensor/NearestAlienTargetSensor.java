...
public class NearestAlienTargetSensor extends Sensor<LivingEntity> {
    ...
    protected void sense(ServerWorld world, LivingEntity entity) {
        ...
        nearestVisibleMobs.findFirst(it -> {
            ...
            if (ConfigAccessor.isTargetBlacklisted(entity, it)) return false;
            if (ConfigAccessor.isTargetWhitelisted(entity, it)) return true;

            return !(it instanceof AlienEntity) &&
