...
public class SensorTypesJava {
    ...
    public static final SensorType<? extends Sensor<? super LivingEntity>> DESTRUCTIBLE_LIGHT = SensorTypeInvoker.register("destructible_light_sensor", DestructibleLightSensorJava::new);
    ...
    public static final SensorType<? extends Sensor<? super LivingEntity>> NEAREST_ALIEN_WEBBING = SensorTypeInvoker.register("nearest_alien_webbing_sensor", NearestAlienWebbingSensorJava::new);
