...
import com.bvanseg.gigeresque.common.entity.ai.pathing.AmphibiousNavigationJava;
...
public class AquaticAlienEntityJava extends AdultAlienEntityJava {
    public AquaticAlienEntityJava(EntityType<? extends AlienEntityJava> type, World world) {
        super(type, world);
    ...
    public static DefaultAttributeContainer.Builder createAttributes() {
        return LivingEntity.createLivingAttributes()
                ...
                .add(AlienEntityAttributesJava.INTELLIGENCE_ATTRIBUTE, 0.85);
    }

    private final AnimationFactory animationFactory = new AnimationFactory(this);

    private final MobNavigation landNavigation = new MobNavigation(this, world);
    private final AmphibiousNavigationJava swimNavigation = new AmphibiousNavigationJava(this, world);
    ...
    public float getGrowthMultiplier() {
        return GigeresqueJava.config.miscellaneous.aquaticAlienGrowthMultiplier;
    }
