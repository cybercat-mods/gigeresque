...
public class RunnerAlienEntity extends AdultAlienEntity {
    ...
    private static final TrackedData<AlienAttackType> CURRENT_ATTACK_TYPE = DataTracker.registerData(RunnerAlienEntity.class, TrackedDataHandlers.ALIEN_ATTACK_TYPE);
