...
public class NestBlockData {
    ...
    public NestBlockData(int coverage, boolean isCorner, boolean isFloor, boolean isCeiling, boolean isWall, boolean upCoverage, boolean downCoverage, boolean northCoverage, boolean southCoverage, boolean eastCoverage, boolean westCoverage) {
