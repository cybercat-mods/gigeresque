...
//	public static final AlienJarBlock ALIEN_STORAGE_BLOCK_5 = new AlienJarBlock();
	...
	public void initialize() {
		Registry.register(Registry.BLOCK, Constants.modResource("black_fluid"), BLACK_FLUID);
		Registry.register(Registry.BLOCK, Constants.modResource("alien_storage_invis"), ALIEN_STORAGE_BLOCK_INVIS);
		Registry.register(Registry.BLOCK, Constants.modResource("alien_storage_invis2"), ALIEN_STORAGE_BLOCK_INVIS2);
		...
		Registry.register(Registry.BLOCK, Constants.modResource("neomorph_spore_pods"), SPORE_BLOCK);
		Registry.register(Registry.ITEM, Constants.modResource("neomorph_spore_pods"), new mods.cybercat.gigeresque.common.item.GigBlockItem(SPORE_BLOCK, new FabricItemSettings().tab(GigItemGroups.BLOCKS)));
