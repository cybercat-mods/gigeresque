...
public record GigBlocks() implements GigeresqueInitializer {
    ...
    public static final Block ORGANIC_ALIEN_BLOCK = new GigBlock(
        FabricBlockSettings.of()
            .strength(
                Gigeresque.config.alienblockHardness,
                Gigeresque.config.alienblockResistance
            )
     ...
     * FLUID BLOCKS
     */
    private static Properties replaceCheck = Gigeresque.config.blackfuildNonrepacle
    ...
    public void initialize() {
        ...
        Registry.register(
            ...
            Constants.modResource("alien_storage_invis"),
            ALIEN_STORAGE_BLOCK_INVIS
        );
        Registry.register(
            BuiltInRegistries.BLOCK,
            Constants.modResource("alien_storage_invis2"),
        ...
        Registry.register(
            ...
            Constants.modResource("neomorph_spore_pods"),
