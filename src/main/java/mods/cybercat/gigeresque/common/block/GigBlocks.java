...
public record GigBlocks() implements GigeresqueInitializer {
    ...
    public static final NestResinBlock NEST_RESIN = new NestResinBlock(
            FabricBlockSettings.of().sounds(SoundType.HONEY_BLOCK).strength(5.0f, 8.0f));
    ...
    public static final NestResinWebBlock NEST_RESIN_WEB = new NestResinWebBlock(
            FabricBlockSettings.of().sounds(SoundType.HONEY_BLOCK).noCollision().strength(5.0f, 8.0f));
    public static final NestResinWebFullBlock NEST_RESIN_WEB_CROSS = new NestResinWebFullBlock(
            FabricBlockSettings.of().sounds(SoundType.HONEY_BLOCK).noCollision().nonOpaque().requiresTool().strength(
                    5.0f, 8.0f));
    public static final Block ORGANIC_ALIEN_BLOCK = new GigBlock(
            FabricBlockSettings.of().strength(Gigeresque.config.alienblockHardness,
    ...
    public static final Block RESINOUS_ALIEN_BLOCK = new GigBlock(
            FabricBlockSettings.of().requiresTool().strength(Gigeresque.config.alienblockHardness,
     ...
     * FLUID BLOCKS
     */
    private static Properties replaceCheck = Gigeresque.config.blackfuildNonrepacle ? BlockBehaviour.Properties.of().mapColor(
