...
public class Materials {
	public final static Material ACID = new MaterialBuilder(MaterialColor.TERRACOTTA_GREEN).allowsMovement()
			.lightPassesThrough().notSolid().replaceable().destroyedByPiston().build();
	public final static Material NEST_RESIN = new MaterialBuilder(MaterialColor.COLOR_GRAY).burnable().allowsMovement().build();
	public final static Material NEST_RESIN_WEB = new MaterialBuilder(MaterialColor.COLOR_GRAY).burnable().allowsMovement()
			.lightPassesThrough().build();
