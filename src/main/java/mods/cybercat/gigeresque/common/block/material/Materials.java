...
public class Materials {
	public final static Material ACID = new MaterialBuilder(MapColor.TERRACOTTA_GREEN).allowsMovement()
	...
	public final static Material NEST_RESIN_WEB = new MaterialBuilder(MapColor.GRAY).burnable().allowsMovement()
