...
public class LeapAtTargetTask<E extends StalkerEntity> extends DelayedBehaviour<E> {
	...
	protected boolean checkExtraStartConditions(ServerLevel level, E entity) {
		...
		return !entity.isVehicle() && this.target != null && entity.isOnGround() && entity.distanceTo(target) > MAX_LEAP_DISTANCE && yDiff > 3 && !(entity.getBlockY() > target.getBlockY()); // && !entity.isCrawling();
	}
