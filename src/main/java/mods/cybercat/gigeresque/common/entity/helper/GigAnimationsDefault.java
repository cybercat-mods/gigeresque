...
public record GigAnimationsDefault() {
	...
	public static final RawAnimation STATIS_ENTER = RawAnimation.begin().then("stasis_enter", LoopType.PLAY_ONCE).thenLoop("stasis_loop");
	...
	public static final RawAnimation RIGHT_CLAW_BASIC = RawAnimation.begin().then("right_claw_basic", LoopType.PLAY_ONCE);
	public static final RawAnimation LEFT_TAIL_BASIC = RawAnimation.begin().then("left_tail_basic", LoopType.PLAY_ONCE);
	public static final RawAnimation RIGHT_TAIL_BASIC = RawAnimation.begin().then("right_tail_basic", LoopType.PLAY_ONCE);
