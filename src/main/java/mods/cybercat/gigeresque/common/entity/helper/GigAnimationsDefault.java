...
public record GigAnimationsDefault() {
    ...
    public static final RawAnimation STATIS_ENTER = RawAnimation.begin().then("stasis_enter",
            Animation.LoopType.PLAY_ONCE).thenLoop("stasis_loop");
    ...
    /* EGG ANIMATIONS */
    public static final RawAnimation HATCHING = RawAnimation.begin().then("hatch", Animation.LoopType.PLAY_ONCE).thenPlayAndHold(
            "hatched");
