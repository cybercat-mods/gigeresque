...
public class RavenousTempleBeastEntity extends CrawlerAdultAlien implements GeoEntity {
    private final AnimatableInstanceCache cache = AzureLibUtil.createInstanceCache(this);

    public RavenousTempleBeastEntity(EntityType<? extends AdultAlienEntity> entityType, Level level) {
        super(entityType, level);
    }

    public static AttributeSupplier.Builder createAttributes() {
        return LivingEntity.createLivingAttributes().add(Attributes.MAX_HEALTH, Gigeresque.config.ravenousTempleBeastXenoHealth)
