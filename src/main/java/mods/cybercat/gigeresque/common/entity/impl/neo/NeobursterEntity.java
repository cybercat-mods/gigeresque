...
public class NeobursterEntity extends RunnerbursterEntity {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return LivingEntity.createLivingAttributes()
            .add(
                ...
                Gigeresque.config.neobursterXenoHealth
            )
            ...
            .add(
                ...
                Gigeresque.config.neobursterAttackDamage
            )
    ...
    public BrainActivityGroup<ChestbursterEntity> getIdleTasks() {
        return BrainActivityGroup.idleTasks(
            ...
            new OneRandomBehaviour<ChestbursterEntity>(
                new SetRandomWalkTarget<>().speedModifier(0.45f),
    ...
    public BrainActivityGroup<ChestbursterEntity> getFightTasks() {
        return BrainActivityGroup.fightTasks(
            ...
            new SetWalkTargetToAttackTarget<>().speedMod((owner, target) -> 2.3F),
