    ...
    public static AttributeSupplier.Builder createAttributes() {
        return LivingEntity.createLivingAttributes()
            .add(
                ...
                Gigeresque.config.neomorph_adolescentXenoHealth
            )
            ...
            .add(
                ...
                Gigeresque.config.neomorph_adolescentAttackDamage
            )
        ...
        controllers.add(new AnimationController<>(this, Constants.LIVING_CONTROLLER, 0, event -> {
            ...
            .add(
                new AnimationController<>(
                    ...
                    "alert",
                    RawAnimation.begin().then("hiss", LoopType.PLAY_ONCE)
                ) // reset hands
