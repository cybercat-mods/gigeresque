...
public class NeomorphEntity extends AlienEntity implements GeoEntity, SmartBrainOwner<NeomorphEntity> {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return LivingEntity.createLivingAttributes()
            .add(
                ...
                Gigeresque.config.neomorphXenoHealth
            )
            .add(Attributes.ARMOR, Gigeresque.config.neomorphXenoArmor)
            .add(
                Attributes.ARMOR_TOUGHNESS,
                Gigeresque.config.neomorphXenoArmor
            )
            .add(
            ...
            .add(
                ...
                Gigeresque.config.neomorphAttackDamage
            )
    ...
    public void registerControllers(ControllerRegistrar controllers) {
        controllers.add(new AnimationController<>(this, Constants.LIVING_CONTROLLER, 5, event -> {
            ...
            if (
                event.getAnimatable().getAttckingState() != 1 && velocityLength >= 0.000000001 && !(this.isCrawling() || this
                    .isTunnelCrawling()) && !this.isExecuting() && !isDead && !this.isPassedOut() && !this.swinging
            )
                if (
            ...
            .add(
                new AnimationController<>(
                    ...
                    "idle",
                    RawAnimation.begin().then("idle_land", LoopType.PLAY_ONCE)
                ) // reset hands
    ...
    public BrainActivityGroup<NeomorphEntity> getIdleTasks() {
        return BrainActivityGroup.idleTasks(
            ...
            new OneRandomBehaviour<>(
                new SetRandomWalkTarget<>().speedModifier(0.75f),
