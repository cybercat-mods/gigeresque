...
public class RunnerbursterEntity extends ChestbursterEntity implements GeoEntity, Growable {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return LivingEntity.createLivingAttributes().add(Attributes.MAX_HEALTH,
                Gigeresque.config.runnerbusterHealth).add(Attributes.ARMOR, 2.0).add(Attributes.ARMOR_TOUGHNESS,
                ...
                Gigeresque.config.runnerbusterAttackDamage).add(Attributes.ATTACK_KNOCKBACK, 0.3);
    }
    ...
    public LivingEntity growInto() {
        LivingEntity alien;
        if (Objects.equals(hostId, "runner")) alien = Entities.RUNNER_ALIEN.create(level());
