...
public class RunnerbursterEntity extends ChestbursterEntity implements GeoEntity, Growable {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return LivingEntity.createLivingAttributes()
            .add(
                ...
                Gigeresque.config.runnerbusterHealth
            )
            ...
            .add(
                ...
                Gigeresque.config.runnerbusterAttackDamage
            )
        ...
        return ObjectArrayList.of(
            ...
            new NearbyLivingEntitySensor<ChestbursterEntity>().setPredicate(
                (target, self) -> GigEntityUtils.entityTest(
                    target,
                    self
                ) || !(target instanceof Creeper || target instanceof IronGolem)
            ),
    ...
    public BrainActivityGroup<ChestbursterEntity> getIdleTasks() {
        return BrainActivityGroup.idleTasks(
            ...
            new OneRandomBehaviour<RunnerbursterEntity>(
