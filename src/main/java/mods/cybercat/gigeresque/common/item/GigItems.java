...
public class GigItems implements GigeresqueInitializer {
	...
	public static final BucketItem BLACK_FLUID_BUCKET = new BucketItem(GigFluids.BLACK_FLUID_STILL, new Item.Settings()
			.recipeRemainder(net.minecraft.item.Items.BUCKET).maxCount(1).group(GigItemGroups.GENERAL));
