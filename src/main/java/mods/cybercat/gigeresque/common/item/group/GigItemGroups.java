...
public record GigItemGroups() {
	...
	public static final CreativeModeTab GENERAL = FabricItemGroup.builder(Constants.modResource("items")).icon(() -> new ItemStack(GigItems.ALIEN_SPAWN_EGG)) // icon
	...
	public static final CreativeModeTab BLOCKS = FabricItemGroup.builder(Constants.modResource("blocks")).icon(() -> new ItemStack(GIgBlocks.NEST_RESIN_WEB)) // icon
