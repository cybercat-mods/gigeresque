...
public class GigVillagerTrades {
	...
	public static void addTrades() {
		...
		List<VillagerTrades.ItemListing> gig_trades2 = new ArrayList<>(
				Arrays.asList(VillagerTrades.TRADES.get(VillagerProfession.CARTOGRAPHER).get(5)));
		gig_trades2.add(new TreasureMapForEmeralds(13, GigTags.GIG_EXPLORER_MAPS, "filled_map.gig_dungeon",
				MapDecoration.Type.RED_MARKER, 12, 5));
