...
class AquaticChestbursterEntityModel : AnimatedGeoModel<AquaticChestbursterEntity>() {
    ...
    override fun getAnimationFileLocation(animatable: AquaticChestbursterEntity): Identifier =
        EntityAnimations.AQUATIC_CHESTBURSTER

    override fun setLivingAnimations(
        entity: AquaticChestbursterEntity,
        uniqueID: Int,
        customPredicate: AnimationEvent<*>
    ) {
