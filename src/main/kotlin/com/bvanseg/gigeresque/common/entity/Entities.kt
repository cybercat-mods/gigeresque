...
//
//    private fun <T : Entity> registerAlienType(
//        name: String,
...
//        registerAlienType(EntityIdentifiers.AQUATIC_CHESTBURSTER.path, ::AquaticChestbursterEntity, 0.5f, 0.25f)
...
//    val RUNNER_ALIEN = registerAlienType(EntityIdentifiers.RUNNER_ALIEN.path, ::RunnerAlienEntity, 1.25f, 1.75f)
