 ...
 */
class AquaticChestbursterEntity(type: EntityType<out AquaticChestbursterEntity>, world: World) : ChestbursterEntity(type, world),
    ...
    override fun growInto(): LivingEntity = AquaticAlienEntity(Entities.AQUATIC_ALIEN, world)
